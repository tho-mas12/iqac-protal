    ...
    <div className="flex min-h-screen bg-[#f8fafc]">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="p-6 md:p-8 space-y-8 flex-1">
          ...
          {/* Quick Upload CTA Header */}
          <div className="bg-gradient-to-r from-[#2a1b54] to-[#4c1d95] rounded-3xl p-6 sm:p-8 text-white shadow-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 relative overflow-hidden">
            ...
            <Link
              ...
              className="px-6 py-3.5 bg-white text-purple-900 hover:bg-purple-50 font-bold rounded-2xl shadow-lg transition-all transform hover:-translate-y-0.5 flex items-center gap-2 text-sm shrink-0 z-10"
            >
